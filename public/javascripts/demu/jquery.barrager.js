...
(function($) {
	...
	$.fn.barrager = function(barrage) {
		...
		var getid = barrage.id;
		var barrager_id = "barrager_"+getid;
		var id = '#' + barrager_id;
		...
		var content = $("<a class=' ui-question'  data-whatever_can='" +getid+  "' id='" + barrager_id + "'  data-toggle='modal' data-target='.question-modal'></a>").appendTo(id + " .barrage_box .p");
		content.attr({
